...
# Any War Converter
version=v3.3.2
changelog='New CMLGS CAS Colors'
...
# Process custom cas (add or remove):
	if [ -f ./cas.war ]; then
		...
		if [ "$(md5sum resources.zip | awk '{ print $1 }')" = "3b4caa6094b563b7a90fdfa18904f746" ]; then
			...
			case $cas_logo in
				...
				"Confidentia")
					...
					;;
				"CMLGS Açores")
					cp ./resources/css/cas_cmlgs_maroon.css ./cas/css/cas.css &> /dev/null
					rm -f ./cas/images/bgc.png &> /dev/null
					rm -f ./cas/images/bgcb.png &> /dev/null
					cp ./resources/images/favicon.png ./cas/images/favicon.png &> /dev/null
					cp ./resources/images/logo_cmlgs_acores.png ./cas/images/logo.png &> /dev/null
					cp ./resources/WEB-INF/view/jsp/confidentia/ui/includes/bottom_cmlgs_maroon.jsp ./cas/WEB-INF/view/jsp/confidentia/ui/includes/bottom.jsp &> /dev/null
					cp ./resources/WEB-INF/view/jsp/confidentia/ui/includes/top_cmlgs_maroon.jsp ./cas/WEB-INF/view/jsp/confidentia/ui/includes/top.jsp &> /dev/null
					;;
				"CMLGS Algarve")
					cp ./resources/css/cas_cmlgs_maroon.css ./cas/css/cas.css &> /dev/null
					rm -f ./cas/images/bgc.png &> /dev/null
				...
				"CMLGS Porto")
					...
					;;
				"CMLGS Porto HCP")
					cp ./resources/css/cas_cmlgs_blue.css ./cas/css/cas.css &> /dev/null
					rm -f ./cas/images/bgc.png &> /dev/null
					rm -f ./cas/images/bgcb.png &> /dev/null
					cp ./resources/images/favicon.png ./cas/images/favicon.png &> /dev/null
					cp ./resources/images/logo_cmlgs_porto_hcp.png ./cas/images/logo.png &> /dev/null
					cp ./resources/WEB-INF/view/jsp/confidentia/ui/includes/bottom_cmlgs_blue.jsp ./cas/WEB-INF/view/jsp/confidentia/ui/includes/bottom.jsp &> /dev/null
					cp ./resources/WEB-INF/view/jsp/confidentia/ui/includes/top_cmlgs_blue.jsp ./cas/WEB-INF/view/jsp/confidentia/ui/includes/top.jsp &> /dev/null
					;;
				...
				"CMLGS Torres")
					...
					;;
				"CMLGS Uália")
					cp ./resources/css/cas_cmlgs_red.css ./cas/css/cas.css &> /dev/null
					rm -f ./cas/images/bgc.png &> /dev/null
					rm -f ./cas/images/bgcb.png &> /dev/null
					cp ./resources/images/favicon.png ./cas/images/favicon.png &> /dev/null
					cp ./resources/images/logo_cmlgs_ualia.png ./cas/images/logo.png &> /dev/null
					cp ./resources/WEB-INF/view/jsp/confidentia/ui/includes/bottom_cmlgs_red.jsp ./cas/WEB-INF/view/jsp/confidentia/ui/includes/bottom.jsp &> /dev/null
					cp ./resources/WEB-INF/view/jsp/confidentia/ui/includes/top_cmlgs_red.jsp ./cas/WEB-INF/view/jsp/confidentia/ui/includes/top.jsp &> /dev/null
					;;
				"CMLGS Viseu")
					cp ./resources/css/cas_cmlgs_maroon.css ./cas/css/cas.css &> /dev/null
					rm -f ./cas/images/bgc.png &> /dev/null
